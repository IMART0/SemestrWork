...
public class EventsPageServlet extends HttpServlet {
    final static Logger logger = LogManager.getLogger(EventsPageServlet.class);
    ...
    private void createTemplate(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Event> eventList = eventService.getByName(name != null ? name : "", offset, pageSize);
        int totalPages = eventService.countResult(name != null ? name : "");
